...
$config_url=$_SERVER["SERVER_NAME"].'/source_mau';	

$config['database']['servername'] = 'localhost';
$config['database']['username'] = 'root';
$config['database']['password'] = '';
$config['database']['database'] = 'source_mau';
...
$ip_host = '127.0.0.1';
$mail_host = 'contact@demo10.ninavietnam.org';
$pass_mail = '1234qwer!@';

$config['lang']=array(''=>'Nội Dung Chi Tiết' );#Danh sách ngôn ngữ hỗ trợ

$config['author']['name'] = 'Lý Khắc Điền';
$config['author']['email'] = 'khacdien.nina@gmail.com';
$config['author']['timefinish'] = '2019';
date_default_timezone_set('Asia/Ho_Chi_Minh');


$api_url     = 'https://www.google.com/recaptcha/api/siteverify';
$site_key    = '6LfFQJkUAAAAAIfI0bRJSSpd7hnXWBVDRtr-GMv1';
$secret_key  = '6LfFQJkUAAAAABuQPQ5tn_jOf059SqP3YLJC4BEh';	
