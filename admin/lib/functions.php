...
function _doigia($gia){
		global $d, $giamoi;
		$giamoi =  round( $gia / 1000 );
...
function _phantramgiam($giacu,$giamoi){
		global $d, $phantram;
		$phantram =  round( ($giacu - $giamoi)*100 / $giacu );
...
function get_link_cat($id , $tbl){
	global $d, $row, $sql , $type;

	$sql = "select id,tenkhongdau,ten from table_".$tbl." where id='$id' ";
	$d->query($sql);
	$row = $d->fetch_array();
	if(count($row)>0)
	{
		return "→ <a href='".$row['tenkhongdau']."/'>".$row['ten']."</a>";
	}
	else
	{
		return "";
...
function check_com_type($tenkhongdau){
	global $d, $row, $tbl , $sql;
	$sql = "select id from table_product where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
...
function check_danhmuc_type($tenkhongdau){
	global $d, $row, $tbl , $sql;

	$sql = "select id from table_product_danhmuc where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
	...
	$sql = "select id from table_product_list where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
	...
	$sql = "select id from table_product_cat where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
	...
	$sql = "select id from table_news_danhmuc where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
	...
	$sql = "select id from table_news_list where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
	...
	$sql = "select id from table_news_cat where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
...
function get_type_cat($tenkhongdau , $tbl){
	global $d, $row, $sql , $type;

	$sql = "select id,type from table_".$tbl." where tenkhongdau='$tenkhongdau' ";
	$d->query($sql);
	$row = $d->result_array();
	if(count($row)>0)
	{
