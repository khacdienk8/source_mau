<?php
function get_main_danhmuc($id_danhmuc)
	{
		$sql="select * from table_product_danhmuc where type='sanpham' order by stt asc";
...
<form name="supplier" id="validate" class="form" action="index.php?com=slider&act=save_photo&id=<?=$_REQUEST['id'];?><?php if($_REQUEST['id_slider']!='') echo'&id_slider='. $_REQUEST['id_slider'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
       ...
       <?php if($_REQUEST['type']=='slidersp') { ?>
        <div class="formRow">
			<label>Danh mục sản phẩm</label>
			<div class="formRight">
			<?=get_main_danhmuc($item['id_danhmuc'])?>
			</div>
			<div class="clear"></div>
		</div>
        <?php } ?>
		...
		<div class="formRow">
			...
			<div class="formRight">
               ...
               <div class="note">  
			   <?php if($_REQUEST['type']=='slider')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:550px '; ?>
                 
                <?php if($_REQUEST['type']=='slide2' || $_REQUEST['type']=='slide3')echo 'Width:1366px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:350px '; ?>  
                
                <?php if($_REQUEST['type']=='hiephoi' || $_REQUEST['type']=='doitac')echo 'Width:160px &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Height:120px '; ?>  
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=_format_duoihinh_l?> 
    			</div>
			</div>
			<div class="clear"></div>
