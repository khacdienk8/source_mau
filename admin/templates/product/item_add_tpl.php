...
$d->reset();
$sql_size="select * from #_product_price where id_pro='".$item['id']."'  order by id asc ";
$d->query($sql_size);
$ds_price=$d->result_array();
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
		...
		<div class="formRow none">
			...
			<div class="formRight">
			<?=get_thuonghieu(@$item['id_thuonghieu'])?>
			</div>
			<div class="clear"></div>
		</div>
        ...
        <div class="formRow none">
            <label>Xuất xứ:</label>
            <div class="formRight">
                <input type="text" id="code_pro" name="nhasanxuat" value="<?=@$item['nhasanxuat']?>"  title="Nhập xuất xứ" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
        <div class="formRow none">
            ...
            <div class="formRight">
                <input type="text" id="code_pro" name="quycach" value="<?=@$item['quycach']?>"  title="Quy cách đóng gói" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
            ...
            <div id="p_scents">
            <?php foreach($ds_price as $s => $value) { ?>	
            <div class="formRight">
            	<input type="text" id="sizesp" name="sizesp_name<?=$s?>" value="<?=$value['size']?>"  title="Nhập giá" class="tipS" placeholder="Kích thước" />

                <input type="button" class="btn_remove" name="" value="Xóa" />
            </div>
        	<?php } ?>
            ...
            <a href="#" id="addScnt">Thêm Size</a>
            <input type="hidden" class="count_size" name="count_size" value="<?=count($ds_price)?>"   />
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="formRow">
			...
			<div class="formRight">
				...
				<div class="note">Width:600px | Height:660px<?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_sanpham.$item['photo']?>"  width="150px" alt="NO PHOTO" /></div>
 	...
 	<div class="formRow">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <textarea  rows="8" cols="" title="Viết mô tả ngắn bài viết" class="" name="mota<?=$key?>" id="mota<?=$key?>"><?=@$item['mota'.$key]?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
...
<script type="text/javascript">
	...
	$(document).ready(function(e) {
        ...
        var i = $('#p_scents .formRight').size();
        
        $('#addScnt').click(function(){

                $('<div class="formRight"><input type="text" id="sizesp" name="sizesp_name' + i + '" value=""  title="Nhập giá" class="tipS" placeholder="Kích thước" /> <input type="button" class="btn_remove" name="" value="Xóa" /></div>').appendTo(scntDiv);
                i++;
                $('.count_size').val(i);
                return false;
        });
