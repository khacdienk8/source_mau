...
<form name="supplier" id="validate" class="form" action="index.php?com=background&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
        ...
        <?php
			if($_REQUEST['type']!='banner' and $_REQUEST['type']!='banner_mobi')
        ...
        <div id="content_lang_<?=$key?>" class="tab_content">	
            ...
            <div class="formRow" >
                ...
                <div class="formRight">
                    ...
                    <?php if($_REQUEST['type']=='banner') { ?><span class="size_img">Chiều rộng <b>640px</b> Chiều cao: <b>150px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='logo') { ?><span class="size_img">Chiều rộng <b>250px</b> Chiều cao: <b>150px</b></span><?php } ?>
                    <?php if($_REQUEST['type']=='watermark') { ?><span class="size_img">Chiều rộng <b>120px</b> Chiều cao: <b>120px</b></span><?php } ?>
