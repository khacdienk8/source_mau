...
<form name="supplier" id="validate" class="form" action="index.php?com=yahoo&act=save<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?>&type=<?=$_REQUEST['type']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
       ...
       <div id="info" class="tab_content">
	        ...
	        <div class="formRow none">
				<label>Zalo</label>
				<div class="formRight">
	                <input type="text" name="yahoo" title="Nhập nick chat Zalo" id="Zalo" class="tipS validate[required]" value="<?=@$item['yahoo']?>" />
				</div>
				<div class="clear"></div>
			</div>
	        <div class="formRow none">
