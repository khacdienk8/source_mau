...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=news&act=add<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
      ...
      <tr>
		...
		<td width="100">File / Ảnh</td>
		<?php } ?>
        
		<?php if($_GET['type']=='tintuc' || $_GET['type']=='kienthuc') { ?>
    ...
    <tbody>
        ...
        <td align="center">
            ...
            <a target="_blank" href="<?=_upload_tintuc.$items[$i]['file_upload']?>"><?=$items[$i]['file_upload']?></a>
            <?php } else { ?>
           <img src="<?=_upload_tintuc.$items[$i]['thumb']?>" style="max-height:40px; max-width:80px;" />
           <?php } ?>
        </td>
        <?php } ?>
