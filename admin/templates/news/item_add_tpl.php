<script language="javascript">	
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?><?php if($_REQUEST['type']!='') echo"&type=".$_REQUEST['type']; ?>&id_danhmuc="+a.value+"&id_list="+b.value+"&id_cat="+c.value;	
		return true;
	}	
...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
    ...
    <div class="formRow none">
        ...
        <div class="clear"></div>
            ...
            <div class="mt10"><a href="<?=_upload_tintuc.$item['file_upload']?>"><?=$item['file_upload']?></a></div>
        ...
        <img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
                <?php if($_GET['type']=='visao') { ?>
                <div class="note"> Width:290px | Height:90px<?=_format_duoihinh_l?> </div>
                <?php } else { ?>
        ...
        <div class="clear"></div>
            ...
            <div class="mt10"><img src="<?=_upload_tintuc.$item['photo']?>"  width="100px" alt="NO PHOTO" /></div>
    ...
    <?php }?>
 	...
 	<div class="formRow">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <div class="formRow">
            <label><?php if($_GET['type']!='bando') echo "Mô tả ngắn:"; else echo "Iframe Map:"; ?></label>
