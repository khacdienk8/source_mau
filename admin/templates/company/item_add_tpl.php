...
<form name="supplier" id="validate" class="form" action="index.php?com=company&act=save" method="post" enctype="multipart/form-data">
    ...
    <div class="formRow">
      ...
      <div class="formRight">
        <input type="text" value="<?=@$item['dienthoai2']?>" name="dienthoai2" title="Nhập số điện thoại 2" class="tipS" />
      </div>
      <div class="clear"></div>
		</div>
    ...
    <div class="formRow">
      ...
      <div class="formRight">
        <input type="text" value="<?=@$item['giomocua']?>" name="giomocua" title="Nhập giomocua" class="tipS" />
      </div>
      <div class="clear"></div>
    </div> 
     ...
     <div class="formRow">
			...
			<div class="formRight">
                <textarea rows="4" cols="" title="Nhập Iframe google map" class="tipS" name="map"><?=@$item['map']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
   ...
   <div class="formRow">
			<label>Zalo</label>
			<div class="formRight">
				<input type="text" value="<?=@$item['zalo']?>" name="zalo" title="Nhập địa chỉ zalo" class="tipS" />
			</div>
			<div class="clear"></div>
		</div>
